...
$query="select * from `registration`.`faculty` where `registration`.`faculty`.HOD_ID = '$studentId'"; 
...
<body>
    <nav class="navbar navbar-expand-custom navbar-mainbg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item ">
                <a class="nav-link" href="p1_teacher.php?id=<?php echo urlencode($studentId); ?>">
    <i class="far fa-address-book"></i>Dashboard
</a>
                </li>
	...
	<tr> 
		...
		{ 
		?> 
		<tr> <td onclick= "getCellContent(this) " class="name_id"><?php echo $rows['FAID']; ?></td> 
...
<script>
    ...
    console.log(content);
            ...
            window.location.href = 'fa_details.php?id=' + content;
        }
</script>

...
<meta name="theme-color" content="#1885ed">
  <title>DAT-LAB.io - Homepage</title>
</head>

<body>
<header class="header">
  <div class="container header__container">
<div class="header__logo"> <h1 class="header__title">DAT-LAB<span class="header__light">.io</span></h1></div> 
  ...
  <div class="header__menu">
    <nav id="navbar" class="header__nav collapse">
      <ul class="header__elenco">
        <li class="header__el"><a href="home.php" header__link">Home</a></li>
        
        <li class="header__el header__el--blue"><a href="studentRegistration.php" class="btn btn--white">Register →</a></li>
      </ul>
    </nav>
  </div>
    </div>
...
Effortless Student Data Management, Elevating Academic Excellence.</h1>
      <h2 class="site__subtitle">simple , faster & productive</h2>
      <div class="site__box-link">
        <a class="btn btn--revert btn--width" href="login_teacher.php">Log-in as HOD</a>
        <a class="btn btn--revert btn--width" href="login_student.php">Log-in as Student</a>
...
<div class="row row--center">
  ...
  <h2 class="row__sub">Enroll into the new courses</h2>
</div>
<br>
  <br>
  <br>
<div class="row row--center row--margin">
  ...
  <h2 class="row__sub">View student details</h2>
  <br>
  <br>
  <br>
</div>
...
<div class="sect sect--padding-bottom">
  ...
  <h2 class="row__sub">Feel free to ask any questions</h2>
    ...
    <div class="row row--margin">
      ...
      <div class="col-md-4">
        <div class="contacts">
          <a href="#" class="contacts__link"><img src="https://image.ibb.co/kcVou6/path3000.png"><h1 class="contacts_title-ag">DAT-LAB<span class="contacts--light">.io</span></h1></a>
          ...
          <p class="contacts__info">
            m. <a href="#"class="contacts__info-link">info@datlab.io</a>
          </p>
        </div>
      </div>
      <div class="col-md-6">
        <form id="contact" class="form">
          <div class="form-group">
            <select class="form__field form__select">
              ...
              <option value=2>Data Protection</option>
            </select>
            </div>
           <div class="form-group">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-2 col-xs-6">
       <img class="footer__img" src="https://image.ibb.co/kcVou6/path3000.png"> <h1 class="footer__title">DAT-LAB<span class="footer__light">.io</span></h1></div>
